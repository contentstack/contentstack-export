...
exportEntries.prototype.getEntry = function (apiDetails) {
  ...
  return new Promise(function (resolve, reject) {
    var requestObject = {
      url: config.cdn + config.apis.content_types + apiDetails.content_type + config.apis.entries +
        apiDetails.uid,
      method: 'GET',
...
exportEntries.prototype.getEntries = function (apiDetails) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    requestObject.uri = config.cdn + config.apis.content_types + apiDetails.content_type + config.apis.entries;
